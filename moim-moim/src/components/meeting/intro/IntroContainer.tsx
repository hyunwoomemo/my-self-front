        ...
        <div className="relative" style={{ height: "calc(100vh - (21px + 4.625rem))" }}>
          ...
          <div className="absolute z-10 flex h-full w-full flex-col gap-5 bg-black bg-opacity-60 px-5 py-5">
            <div className="flex flex-1 flex-col justify-between">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <div className="flex gap-1">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-white">현재 인원/{data.max_members}</span>
                      </div>
                    </div>
              ...
              <div className="h_sm:max-h-44 h_lg:max-h-64 h_xl:max-h-96 scrollbar w-full overflow-y-auto whitespace-pre-wrap break-all rounded-xl bg-black bg-opacity-80 p-4 text-white">
                {data.description}
              </div>
            </div>
